            ...
            <ScrollView style={{backgroundColor: 'black'}}>
                <View style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
                    ...
                    <Text style={styles.text}>
                        Культурно оздоровительный комплекс с гостиницей и ресторанами в п. Сокирна, Черкасской
                        области. Находится на правом берегу Днепра в самом центре Украины, в зеленой,
                    ...
                    <Text style={styles.text}>
                        Для Вашего отдыха доступны гостиница, открытый бассейн с видом на Днепр, закрытый бассейн с зоной
                        джакузи,
                    ...
                    <Text style={styles.text}>
                        ...
                        количеством посетителей можно использовать общий зал. Деловая встреча пройдет
                        в отдельно оборудованных аудиториях, где вас никто не потревожит.
                    </Text>
                    ...
                    <Text style={styles.text}>
                        ...
                        Каневские горы, заповедник «Урочище Холодный Яр», город Чигирин, и
