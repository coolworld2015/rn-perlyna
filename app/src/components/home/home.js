            ...
            <ScrollView style={{backgroundColor: 'black'}}>
                <View style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
                    ...
                    <Text style={styles.text2}>
                        ...
                        район. Мы находимся на правом берегу Днепра, в самом центре Украины.
                    ...
                    <Text style={styles.text}>
                        ...
                        Каневские горы, Мошногорье, заповедник «Урочище Холодный Яр»,село Суботов, город Чигирин, и
